  ...
  })()(
    {
      ...
      4: [
        function (require, module, exports) {
          ...
          exports.EmailJSResponseStatus =
            EmailJSResponseStatus_1.EmailJSResponseStatus;
          ...
          function sendPost(url, data, headers) {
            ...
            return new Promise(function (resolve, reject) {
              ...
              xhr.addEventListener("error", function (event) {
                reject(
                  new EmailJSResponseStatus_1.EmailJSResponseStatus(
                    event.target
                  )
                );
              });
          ...
          function sendForm(serviceID, templateID, form, userID) {
            ...
            return sendPost(
              _origin + "/api/v1.0/email/send-form",
              formData
            ).then(
              function (response) {
